...
setwd("C:/Users/graduate/Box/DiviningWater/Wellsville2019/Soil Sensor Data/Sensor 101")
...
abline(h=-sd2, col='steelblue3', lwd=3)
abline(h=-sd3, col='gold3', lwd=3)
abline(h=-sd4, col='olivedrab3', lwd=3)
legend('bottomleft', inset=0.02, lty=1, lwd=3, legend=c('Sensor 1','Sensor 2','Sensor 3','Sensor 4'), col=c('coral3','steelblue3','gold3','olivedrab3'), ncol=2)
dev.off()

# Plot daily soil moisture data
# Sub-station 1
tiff(file="DailySM1.tiff",
     width=420, height=297, units="mm", res=600)
...
lines(data.101$Date.101, sm2, type='l', lwd=3, col='steelblue3')
lines(data.101$Date.101, sm3, type='l', lwd=3, col='gold3')
lines(data.101$Date.101, sm4, type='l', lwd=3, col='olivedrab3')
...
dev.off()
# Sub-station 101
tiff(file="DailySM101.tiff",
     width=420, height=297, units="mm", res=600)
plot (data.101$Date.101, sm5, ylim=c(0, 60), type='l', lwd=3, col='coral3', 
...
lines(data.101$Date.101, sm8, type='l', lwd=3, col='olivedrab3')
...
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()

# ET/ETo for sub-station 1
Kc.A.1=ET.A.1/ETo
tiff(file="Kc.A.1.tiff",
     width=420, height=297, units="mm", res=600)
...
tiff(file="ET.A.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, ET.A.101, 
     type='h', lwd=3, col='darkslategray3',
     main='Daily ET from sub-station 101: Method A', xlab='', ylab='ET (mm)',
     ylim=c(0, 12))
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()
...
tiff(file="Kc.A.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.A.101,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 101: Method A', xlab='', ylab='Kc')
dev.off()
...
tiff(file="ET.B.1.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, ET.B.1,
     ylim=c(0, 12), type='h', col='darkslategray3', lwd=3,
     main='Daily ET for sub-station 1: Method B', xlab='', ylab='ET (mm)')
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()

# Heatmap: shows how the soil layers contribute to total ET
...
tiff(file="ET.B.1_Heatmap.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(heatmap.data, mapping=aes(x, y, fill=ET),) +
  geom_tile() +
  labs(x='', y='', title='Daily ET (mm) for sub-station 1: Method B') +
...
# ET/ETo
Kc.B.1=ET.B.1/ETo
tiff(file="Kc.B.1.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.B.1,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 1: Method B', xlab='', ylab='Kc')
dev.off()

# Sub-station 101: sensors 5-8
# Total ET
...
tiff(file="ET.B.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, ET.B.101,
     ylim=c(0, 12), type='h', col='darkslategray3', lwd=3,
     main='Daily ET for sub-station 101: Method B', xlab='', ylab='ET (mm)')
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()
...
heatmap.data=expand.grid(x=x, y=y)
tiff(file="ET.B.101_Heatmap.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(heatmap.data, mapping=aes(x, y, fill=ET),) +
  geom_tile() +
  labs(x='', y='', title='Daily ET (mm) for sub-station 101: Method B') +
  scale_fill_viridis(direction=-1, na.value='white') +
  theme_ipsum()
dev.off()
...
tiff(file="Kc.B.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.B.101,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 101: Method B', xlab='', ylab='Kc')
dev.off()
...
tiff(file="ET.C.1.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, ET.C.1,
     ylim=c(0, 12),
     type='h', col='darkslategray3', lwd=3,
     main='Daily ET for sub-station 1: Method C', xlab='', ylab='ET (mm)')
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()
...
ET[ET==0]=NA # turns zeros into NAs
heatmap.data=expand.grid(x=x, y=y)
tiff(file="ET.C.1_Heatmap.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(heatmap.data, mapping=aes(x, y, fill=ET),) +
  geom_tile() +
  labs(x='', y='', title='Daily ET (mm) for sub-station 1: Method C') +
  scale_fill_viridis(direction=-1, na.value='white') +
  theme_ipsum()
dev.off()
...
# ET/ETo 
Kc.C.1=ET.C.1/ETo
tiff(file="Kc.C.1.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.C.1,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 1: Method C', xlab='', ylab='Kc')
dev.off()
...
tiff(file="ET.C.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, ET.C.101,
     ylim=c(0, 12),
     type='h', col='darkslategray3', lwd=3,
     main='Daily ET for sub-station 101: Method C', xlab='', ylab='ET (mm)')
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()
...
ET[ET==0]=NA # turns zeros into NAs
heatmap.data=expand.grid(x=x, y=y)
tiff(file="ET.C.101_Heatmap.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(heatmap.data, mapping=aes(x, y, fill=ET),) +
  geom_tile() +
  labs(x='', y='', title='Daily ET (mm) for sub-station 101: Method C') +
  scale_fill_viridis(direction=-1, na.value='white') +
  theme_ipsum()
dev.off()
...
tiff(file="Kc.C.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.C.101,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 101: Method C', xlab='', ylab='Kc')
dev.off()
...
tiff(file="ET.D.1.tiff",
     width=420, height=297, units="mm", res=600)
plot(sensor1$Date, sensor1$ET,
     type='h', lwd=3, col='darkslategray3',
     main='Daily ET from sub-station 1: Method D', xlab='', ylab='ET (mm)',
     ylim=c(0,15))
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()
...
# ET/ETo for sub-station 1
Kc.D.1=ET.D.1/ETo
tiff(file="Kc.D.1.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.D.1,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 1: Method D', xlab='', ylab='Kc')
dev.off()
...
tiff(file="ET.D.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(sensor101$Date, sensor101$ET,
     type='h', lwd=3, col='darkslategray3',
     main='Daily ET from sub-station 101: Method D', xlab='', ylab='ET (mm)',
     ylim=c(0, 12))
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()
...
tiff(file="Kc.D.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.D.101,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 101: Method D', xlab='', ylab='Kc')
dev.off()
...
tiff(file="ET.E.1.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, ET.E.1, 
     type='h', lwd=3, col='darkslategray3',
     main='Daily ET for sub-station 1: Method E', xlab='', ylab='ET (mm)',
     ylim=c(0, 12))
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()
...
ET[ET==0]=NA # turns zeros into NAs
heatmap.data=expand.grid(x=x, y=y)
tiff(file="ET.E.1_Heatmap.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(heatmap.data, mapping=aes(x, y, fill=ET),) +
  geom_tile() +
  labs(x='', y='', title='Daily ET (mm) for sub-station 1: Method E') +
  scale_fill_viridis(direction=-1, na.value='white') +
  theme_ipsum()
dev.off()
...
# ET/ETo for sub-station 1
Kc.E.1=ET.E.1/ETo
tiff(file="Kc.E.1.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.E.1,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 1: Method E', xlab='', ylab='Kc')
dev.off()
...
tiff(file="ET.E.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, ET.E.101, 
     type='h', lwd=3, col='darkslategray3',
     main='Daily ET for sub-station 101: Method E', xlab='', ylab='ET (mm)',
     ylim=c(0, 12))
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()
...
ET[ET==0]=NA # turns zeros into NAs
heatmap.data=expand.grid(x=x, y=y)
tiff(file="ET.E.101_Heatmap.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(heatmap.data, mapping=aes(x, y, fill=ET),) +
  geom_tile() +
  labs(x='', y='', title='Daily ET (mm) for sub-station 101: Method E') +
  scale_fill_viridis(direction=-1, na.value='white') +
  theme_ipsum()
dev.off()
...
tiff(file="Kc.E.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.E.101,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 101: Method E', xlab='', ylab='Kc')
dev.off()
...
tiff(file="ET.F.1.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, ET.F.1, 
     type='h', lwd=3, col='darkslategray3',
     main='Daily ET sub-station 1: Method F', xlab='', ylab='ET (mm)',
     ylim=c(0, 12))
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()
...
ET[ET==0]=NA # turns zeros into NAs
heatmap.data=expand.grid(x=x, y=y)
tiff(file="ET.F.1_Heatmap.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(heatmap.data, mapping=aes(x, y, fill=ET),) +
  geom_tile() +
  labs(x='', y='', title='Daily ET (mm) sub-station 1: Method F') +
  scale_fill_viridis(direction=-1, na.value='white') +
  theme_ipsum()
dev.off()
...
# ET/ETo ~ crop coefficient
Kc.F.1=ET.F.1/ETo
tiff(file="Kc.F.1.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.F.1,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 1: Method F', xlab='', ylab='Kc')
dev.off()
...
tiff(file="ET.F.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, ET.F.101, 
     type='h', lwd=3, col='darkslategray3',
     main='Daily ET for sub-station 101: Method F', xlab='', ylab='ET (mm)',
     ylim=c(0,12))
lines(data.101$Date.101, ETo, type='l', xlab='2019', ylab='Reference ET (mm)', col='palegreen3', lwd=3)
legend('topright', legend=c('ETo', 'ET'), col=c('palegreen3', 'darkslategray3'), lwd=3, inset=0.02)
dev.off()
...
ET[ET==0]=NA # turns zeros into NAs
heatmap.data=expand.grid(x=x, y=y)
tiff(file="ET.F.101_Heatmap.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(heatmap.data, mapping=aes(x, y, fill=ET),) +
  geom_tile() +
  labs(x='', y='', title='Daily ET (mm) for sub-station 101: Method F') +
  scale_fill_viridis(direction=-1, na.value='white') +
  theme_ipsum()
dev.off()
...
tiff(file="Kc.F.101.tiff",
     width=420, height=297, units="mm", res=600)
plot(data.101$Date.101, Kc.F.101,
     ylim=c(0, 2),
     type='h', lwd=3, col='orchid3',
     main='Daily ET/ETo for sub-station 101: Method F', xlab='', ylab='Kc')
dev.off()
...
# Box-plot for ET
tiff(file="ET.1_Comparison.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(comparison.1, aes(x = method, y = ET, fill = date)) +
  ...
  ggtitle("Daily ET for sub-station 1: Method comparison") +
  xlab("")+ylab("ET (mm)") + 
  geom_boxplot(color="black", fill="darkslategray3")
dev.off()

# Box-plot for ET/ETo
tiff(file="Kc.1_Comparison.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(comparison.1, aes(x = method, y = Kc, fill = date)) +
  ...
  ggtitle("Daily ET/ETo for sub-station 1: Method comparison") +
  xlab("") + ylab("ET/ETo") +
...
# Box-plot ET
tiff(file="ET.101_Comparison.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(comparison.101, aes(x = method, y = ET, fill = date)) +
  ...
  ggtitle("Daily ET for sub-station 101: Method comparison") +
  xlab("") + ylab("ET (mm)") +
  geom_boxplot(color="black", fill="darkslategray3")
dev.off()
...
# Box-plot ET/ETo
tiff(file="Kc.101_Comparison.tiff",
     width=420, height=297, units="mm", res=600)
ggplot(comparison.101, aes(x = method, y = Kc, fill = date)) +
  ...
  ggtitle("Daily ET/ETo for substation 101: Method comparison") +
  xlab("") + ylab("ET/ETo") +
  geom_boxplot(color="black", fill="orchid3")
dev.off()
